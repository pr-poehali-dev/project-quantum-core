export function Footer() {
  const footerLinks = {
    "Каталог": ["Фотоаппараты", "Объективы", "Вспышки и свет", "Штативы", "Сумки и чехлы", "Карты памяти", "Фильтры"],
    "Бренды": ["Sony", "Canon", "Nikon", "Fujifilm", "Leica", "Sigma", "Tamron"],
    "Покупателям": ["Доставка и оплата", "Гарантия", "Возврат", "Рассрочка", "Корпоративные заказы", "Бонусная программа"],
    "Компания": ["О нас", "Отзывы", "Карьера", "Новости", "Сертификаты", "Конфиденциальность", "Условия"],
    "Связаться": ["Контакты", "Telegram", "Instagram", "YouTube", "VK"],
  }
