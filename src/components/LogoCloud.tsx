...
import { Camera, Aperture, Focus, ScanLine, Zap, Layers, Circle, Square } from "lucide-react"

const companies = [
  { name: "Sony", icon: Camera },
  { name: "Canon", icon: Aperture },
  { name: "Nikon", icon: Focus },
  { name: "Fujifilm", icon: ScanLine },
  { name: "Leica", icon: Zap },
  { name: "Olympus", icon: Layers },
  { name: "Sigma", icon: Circle },
  { name: "Tamron", icon: Square },
]
    ...
    <div className="relative z-20 pb-24 pt-8" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            От профессиональных зеркалок до компактных беззеркалок.
          </motion.p>
